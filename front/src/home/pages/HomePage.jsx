...
export const HomePage = () => {
  return (
    <>
      ...
      <div className="container-xxl ">
        ...
        <div className="text-center mb-5 descripcion-curso">
          ...
          <div className="row gx-0">
            <div className="col-3 card img3 ">
              <div>
                <img className="img-fluid" src={ini1} alt="" />
              </div>
              <NavLink to="/cursos/1" className="nav-link">
                <div className="card_title title-white justify-content-center align-items-center">
                  <p className="mb-0">Contabilidad Basica</p>
            ...
            <div className="col-3 card img3">
              ...
              <NavLink to="/cursos/1" className="nav-link">
                <div className="card_title title-white justify-content-center align-items-center">
                  <p className="mb-0">Marketing Digital Basico</p>
                  <h3>Curso Gratuito</h3>
                </div>
              </NavLink>
              <div className="card_icon">
            ...
            <div className="col-3 card img3">
              ...
              <NavLink to="/cursos/1" className="nav-link">
                <div className="card_title title-white justify-content-center align-items-center">
                <p className="mb-0">Conoce Todos Nuestros Cursoss</p>
                  <h3>Curso Gratuito</h3>
                </div>
              </NavLink>
              <div className="card_icon">
      ...
      <div className="row gx-3 callout container-xxl text-center">
        <div>
        ...
        <div className="row  card2 p-3  ">
          <div className="col text-center title-curso text-black">
            <p>INFORMACIÓN DE NUESTROS CURSOS</p>
          </div>

          <div className="col text-center  text-body titleC  text-black">
            <p>PROWESS OFRECE CURSOS DE CAPACITACIÓN EN LAS SIGUENTES AREAS.</p>
          </div>
        </div>
      </div>

      <div className="row gx-3  container-xxl ">
        <div className="col-4 ">
          <div>
      ...
      <div className="row gx-3 callout container-xxl text-center">
        <div>
          ...
          <div className="row  card1 p-3 title-white">
            <div className="col ">
              <div className="col text-center titleC  title-white">
                <p>Administracíon</p>
